...
<h3>Principal Medical AI Researcher | Pathology Foundation Model Robustness | FDA Approved Radiology AI</h3><br>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 1em;">
  ...
  <div style="margin-top: 0; flex: 1;">
    <p style="margin-top: 0;">
      <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 0.5em;">
        <span class="small-caps">Mentor, coaching A.I. startups</span>
        <span class="small-caps">Sep 2017 - Jul 2021</span>
      </div>
...
<a id="papers" style="display: block; position: relative; top: -50px; visibility: hidden;"></a>
